...
assert.equal(
  whatap.fromInteger(HashString("Hello, World!")), 
  whatap.fromString("Hello, World!")
);
assert.equal(
  whatap.fromInteger(HashString("Thank you WhaTap")), 
  whatap.fromString("Thank you WhaTap")
)
console.log("** Completed **");

console.log("2. HEX to RGB Testing")
assert.equal(
  whatap.hexToRgb("#123456"),
  "rgb(18,52,86)"
)
assert.equal(
  whatap.hexToRgb("6F3DAA"),
  "rgb(111,61,170)"
)
assert.equal(
  whatap.hexToRgb("#FFFFFF"),
  "rgb(255,255,255)"
)
assert.equal(
  whatap.hexToRgb("806F3DAA"),
  "rgba(111,61,170,0.5)"
)

// console.log("6. RGBA to HEX Testing")
// assert.equal(
